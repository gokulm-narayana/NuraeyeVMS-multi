...
app.controller('SearchController', ['$scope', 'MockBackendService', function ($scope, MockBackendService) {
    ...
    MockBackendService.getCameras().then(function (cams) {
        if (cams && cams.length > 0) {
            ...
            // Provide dummy cameras if the backend returns empty
            $scope.availableCameras = [
                { id: 1, name: 'Main Entrance' },
                { id: 2, name: 'Lobby Cam' },
                { id: 3, name: 'Parking Lot A' },
                { id: 4, name: 'Parking Lot B' },
                { id: 5, name: 'Perimeter West' },
                { id: 6, name: 'Loading Dock' }
            ];
        }
    });
                ...
                $scope.searchResults = [
                    {
                        id: 101,
                        confidence: 96,
                        cameraName: $scope.searchParams.cameras.length > 0 ? 'Selected Cam 1' : 'Main Entrance',
                        timestamp: new Date().getTime() - 1000 * 60 * 5, // 5 mins ago
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1549317661-bd32c8ce0db2?auto=format&fit=crop&q=80&w=300&h=200'
                    },
                    {
                        id: 102,
                        confidence: 92,
                        ...
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?auto=format&fit=crop&q=80&w=300&h=200'
                    },
                    {
                        id: 103,
                        confidence: 88,
                        cameraName: 'Lobby Cam',
                        timestamp: new Date().getTime() - 1000 * 60 * 120, // 2 hrs ago
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1494976388531-d1058494cdd8?auto=format&fit=crop&q=80&w=300&h=200'
                    },
                    {
                        id: 104,
                        confidence: 84,
                        cameraName: 'Perimeter West',
                        timestamp: new Date().getTime() - 1000 * 60 * 180, // 3 hrs ago
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1552519507-da3b142c6e3d?auto=format&fit=crop&q=80&w=300&h=200'
                    },
                    {
                        id: 105,
                        confidence: 79,
                        cameraName: 'Loading Dock',
                        timestamp: new Date().getTime() - 1000 * 60 * 300, // 5 hrs ago
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1503376760367-13eea3ff2851?auto=format&fit=crop&q=80&w=300&h=200'
                    },
                    {
                        id: 106,
                        confidence: 72,
                        cameraName: 'Parking Lot B',
                        timestamp: new Date().getTime() - 1000 * 60 * 1440, // 24 hrs ago
                        tag: specificTag,
                        thumbnailUrl: 'https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&q=80&w=300&h=200'
                    }
                ];
            });
        }, 1500);
